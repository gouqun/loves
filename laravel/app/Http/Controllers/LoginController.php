...
class LoginController extends Controller
{
    public function login(Request $request)
    {
            ...
            $duse = ['token'=>$token,'data'=>$user->show_name];
...
//        }
    ...
    public function register(Request $request)
    {
        $message = [
            ...
            'req_password.required' => '请输入确认密码',
            'req_password.same' => '请与确认密码一致',
        ];
        $validator = Validator::make($request->post(), [
            ...
            'password' => 'required|alpha_num|between:3,20',
            'req_password' => 'required|same:password',
        ],$message);
